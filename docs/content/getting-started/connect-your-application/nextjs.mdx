...
<CodeGroup>
  ...
  <CodeBlock lang="bash" label="Deno">
    deno run -A npm:create-next-app@latest my-nextjs-app
    cd my-nextjs-app
  </CodeBlock>
</CodeGroup>
...
<NextSteps>
  ...
  <NextStepsCard title="Next.js SDK Reference" href="../../../sdks-and-tools/nextjs/overview" description="Explore the full API reference for the Next.js SDK." cta="API Reference" />
</NextSteps>
