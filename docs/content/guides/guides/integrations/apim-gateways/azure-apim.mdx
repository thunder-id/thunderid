...
- **[Scope-Based Authorization](#configure-scope-based-authorization-in-azure-api-management):** Leverage <ProductName />'s [RBAC](/docs/next/guides/key-concepts/authorization/) capabilities to enforce strict, Azure APIM-driven access control policies on upstream APIs.
