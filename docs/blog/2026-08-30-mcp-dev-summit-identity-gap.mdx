...
description: "Three {{ProductName}} team members presented at MCP Dev Summit events on the same problem viewed from three altitudes: who an agent is acting as when it calls an MCP server, whether it's headless, host-driven, or acting on a user's behalf."
docType: community
...
Three <ProductName /> team members presented at recent MCP Dev Summit events organized by the Agentic AI Foundation. Ayesha spoke at both events, and Hasini and Sahan presented together at one of them.
