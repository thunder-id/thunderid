...
type StoreTestSuite struct {
	...
	ctx            context.Context
	testRequest    par.PushedAuthorizationRequest
}
...
func (s *StoreTestSuite) SetupTest() {
	...
	s.testRequest = par.PushedAuthorizationRequest{
...
func (s *StoreTestSuite) TestConsume_NotFound() {
	...
	assert.Equal(s.T(), par.PushedAuthorizationRequest{}, result)
}
