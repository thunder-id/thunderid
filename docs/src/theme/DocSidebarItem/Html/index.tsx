...
export default function DocSidebarItemHtml(props: OriginalProps): React.ReactElement {
  if (props.item.className === 'connect-type-selector-wrapper') {
    return (
  ...
  return <OriginalDocSidebarItemHtml {...props} />;
}
