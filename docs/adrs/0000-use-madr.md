...
* Good, because no rationale is left somewhere a contributor cannot reach: what is recorded here is readable by anyone who can read the code, rather than sitting in a mail thread or an internal system.
