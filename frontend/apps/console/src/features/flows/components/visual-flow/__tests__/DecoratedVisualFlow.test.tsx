...
describe('DecoratedVisualFlow', () => {
  ...
  describe('Canvas Context Menu', () => {
    ...
    it('should hide preview and disable duplicate for a synthetic stack node', () => {
      ...
      renderComponent(<DecoratedVisualFlow {...defaultProps} nodes={[stackNode]} />);

      fireEvent.click(screen.getByTestId('node-context-menu-trigger'));

      expect(screen.queryByTestId('canvas-context-menu-preview')).not.toBeInTheDocument();
    ...
    it('should not open context menus while the preview is running', () => {
      renderComponent(<DecoratedVisualFlow {...defaultProps} nodes={[contextNode]} />);
    ...
    it('should not duplicate the selection on Ctrl+D while the preview is running', () => {
      mockGetNodes.mockReturnValue([{...contextNode, selected: true}]);
      const setNodes = vi.fn();
      renderComponent(<DecoratedVisualFlow {...defaultProps} nodes={[contextNode]} setNodes={setNodes} />);
