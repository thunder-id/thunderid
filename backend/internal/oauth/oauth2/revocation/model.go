...
// Package revocation provides the OAuth2 token revocation endpoint (RFC 7009) and the write path
// for the single-token deny list (the JTI deny list) backed by the database.operation
// classification. The read/enforcement path lives in the enforcement package.
package revocation
