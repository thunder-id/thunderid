...
1. Invitation emails are delivered through an Email provider. **Configure an Email Provider** in <ProductName />. See [Email Providers](../../../guides/guides/notifications/email-providers).
