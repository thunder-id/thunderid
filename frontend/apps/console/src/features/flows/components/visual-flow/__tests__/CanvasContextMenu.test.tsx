...
describe('CanvasContextMenu', () => {
  ...
  describe('Node menu', () => {
    it('should render the node actions', () => {
      render(
        <CanvasContextMenu {...defaultProps} target={nodeTarget} canDuplicate canDelete hasProperties canPreview />,
      );
    ...
    it('should hide the preview action when the preview cannot start from the node', () => {
    ...
    it('should invoke preview-from-step and close on click', () => {
      render(<CanvasContextMenu {...defaultProps} target={nodeTarget} canDuplicate canDelete canPreview />);
