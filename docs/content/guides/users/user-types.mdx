...
:::warning
Deletion fails if users of this type exist. The Console checks for this before you confirm and disables **Delete** when it finds any; delete or reassign all users of this type first.
:::
