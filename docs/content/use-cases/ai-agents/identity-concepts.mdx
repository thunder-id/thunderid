...
Permissions are included in access tokens. See [Resource Servers](../../../guides/resource-servers).
...
See [Build a Flow](../../../guides/flows/build-a-flow) and [Agent Authentication](../../../guides/agents/agent-authentication).
