...
func (s *scimDiscoveryService) GetServiceProviderConfig(_ context.Context, baseURL string) SCIMServiceProviderConfig {
	...
	return SCIMServiceProviderConfig{
		...
		Pagination: scimPaginationConfig{
			Cursor:                  s.cfg.PaginationCursorSupported,
			Index:                   s.cfg.PaginationIndexSupported,
			DefaultPaginationMethod: s.cfg.PaginationDefaultMethod,
			DefaultPageSize:         s.cfg.PaginationDefaultPageSize,
			MaxPageSize:             s.cfg.PaginationMaxPageSize,
		},
