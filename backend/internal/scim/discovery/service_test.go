...
func TestGetSchema_EnterpriseUserURN_Success(t *testing.T) {
	mockET := entitytypemock.NewEntityTypeServiceInterfaceMock(t)
	mockET.On("GetEntityTypeList", mock.Anything, entitytype.TypeCategoryUser, mock.Anything, mock.Anything, false).
		Return(
			&entitytype.EntityTypeListResponse{
...
func TestGetSchema_EnterpriseUserURN_NoEnterpriseAttrs_Returns404(t *testing.T) {
	mockET := entitytypemock.NewEntityTypeServiceInterfaceMock(t)
	mockET.On("GetEntityTypeList", mock.Anything, entitytype.TypeCategoryUser, mock.Anything, mock.Anything, false).
		Return(
			&entitytype.EntityTypeListResponse{
...
func TestListSchemas_IncludesEnterpriseUserSchema(t *testing.T) {
	mockET := entitytypemock.NewEntityTypeServiceInterfaceMock(t)
	mockET.On("GetEntityTypeList", mock.Anything, entitytype.TypeCategoryUser, mock.Anything, mock.Anything, false).
		Return(
			&entitytype.EntityTypeListResponse{
...
func TestListSchemas_WindowSpansStaticAndDynamicSchemas(t *testing.T) {
	mockET := entitytypemock.NewEntityTypeServiceInterfaceMock(t)
...
func TestListSchemas_LargeRegistry_ConstantQueryCount(t *testing.T) {
	mockET := entitytypemock.NewEntityTypeServiceInterfaceMock(t)
	mockET.On("GetEntityTypeList", mock.Anything, entitytype.TypeCategoryUser, 1, 0, false).
		Return(
			&entitytype.EntityTypeListResponse{
