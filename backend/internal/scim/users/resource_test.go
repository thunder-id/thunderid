...
func (suite *ResourceTestSuite) TestFilterAttrsBySchema() {
	t := suite.T()
	testCases := []struct {
		name       string
...
func (suite *ResourceTestSuite) TestBuildSCIMUserResource() {
	t := suite.T()
	u := providers.User{
		ID:         "user123",
		Type:       "Person",
	...
	require.JSONEq(t, `{"formatted":"John"}`, string(scimUser.CoreAttrs["name"]))
	require.JSONEq(t, `{}`, string(scimUser.Attributes))
}
...
func (suite *ResourceTestSuite) TestBuildSCIMUserResource_IncludeCoreAttrsFalse_OmitsCoreAttrs() {
	t := suite.T()
	u := providers.User{
		ID:         "user123",
		Type:       "Person",
...
func (suite *ResourceTestSuite) TestBuildSCIMUserListResponse_NilUsers() {
	t := suite.T()
...
func (suite *ResourceTestSuite) TestSCIMUser_MarshalJSON() {
	t := suite.T()
...
func (suite *ResourceTestSuite) TestBuildSCIMUserResource_EnterpriseAttrs() {
	t := suite.T()
	u := providers.User{
		ID:         "user123",
		Type:       "Person",
...
func (suite *ResourceTestSuite) TestProjectSCIMAttributes() {
	t := suite.T()
...
func (suite *ResourceTestSuite) TestProjectSCIMUserListResponse() {
	t := suite.T()
...
func (suite *ResourceTestSuite) TestProjectSCIMUserResource() {
	t := suite.T()
	const extURN = "urn:thunderid:params:scim:schemas:employee:2.0:User"
	u := SCIMUser{
		ID:           "u1",
