      ...
      <>
        ...
        <Box sx={{pb: 1.5, flexShrink: 0}}>
          <TextField
            ...
            placeholder={t('flows:core.resourcePanel.search.placeholder')}
            slotProps={{
              htmlInput: {
                'aria-label': t('flows:core.resourcePanel.search.placeholder'),
                type: 'search',
              },
              input: {
                startAdornment: (
                ...
                endAdornment: isSearching ? (
                  <InputAdornment position="end">
                    <IconButton
                      ...
                      aria-label={t('flows:core.resourcePanel.search.clear')}
                    >
                      <XIcon size={14} />
                    </IconButton>
                  </InputAdornment>
        ...
        {isSearching && visibleSections.length === 0 && (
          <Stack alignItems="center" spacing={1} sx={{px: 2, py: 4, color: 'text.secondary'}}>
            <SearchXIcon size={24} />
            <Typography variant="body2">{t('flows:core.resourcePanel.search.noResults')}</Typography>
            <Typography variant="caption" color="text.secondary" textAlign="center">
              {t('flows:core.resourcePanel.search.noResultsHint')}
            </Typography>
          </Stack>
        )}
      </>
