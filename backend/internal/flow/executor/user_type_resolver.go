...
func (u *userTypeResolver) getEntityTypeAndOU(
	...
	return u.resolution.entityTypeAndOU(ctx, entitytype.TypeCategoryUser, userType, u.logger)
}
...
func (u *userTypeResolver) promptUserSelection(
	...
	u.resolution.promptOptions(ctx, execResp, options, u.GetDefaultInputs(), u.logger)
}
...
func (u *userTypeResolver) handleUserOnboardingFlows(ctx *providers.NodeContext,
	...
	return u.resolution.resolve(ctx, entitytype.TypeCategoryUser,
