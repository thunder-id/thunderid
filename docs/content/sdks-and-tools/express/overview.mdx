...
See the [redirect flow guide](/sdks/express/guides/redirect-flow) for the full route wiring pattern.
...
See the [embedded sign-in guide](/sdks/express/guides/embedded-sign-in) for the request and response lifecycle.
