...
func (_mock *OTPAuthnServiceInterfaceMock) GenerateOTP(ctx context.Context, recipient string, recipientAttr string) (string, string, *serviceerror.ServiceError) {
	...
	if returnFunc, ok := ret.Get(2).(func(context.Context, string, string) *serviceerror.ServiceError); ok {
...
func (_c *OTPAuthnServiceInterfaceMock_GenerateOTP_Call) Return(sessionToken string, otpValue string, svcErr *serviceerror.ServiceError) *OTPAuthnServiceInterfaceMock_GenerateOTP_Call {
	_c.Call.Return(sessionToken, otpValue, svcErr)
	return _c
}

func (_c *OTPAuthnServiceInterfaceMock_GenerateOTP_Call) RunAndReturn(run func(ctx context.Context, recipient string, recipientAttr string) (string, string, *serviceerror.ServiceError)) *OTPAuthnServiceInterfaceMock_GenerateOTP_Call {
	_c.Call.Return(run)
	return _c
}
