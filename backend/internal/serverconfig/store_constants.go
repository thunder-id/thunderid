...
var (
	...
	// queryListServerConfigs retrieves all server configs for the deployment.
	queryListServerConfigs = dbmodel.DBQuery{
		ID: "SCF-02",
		Query: `SELECT NAME, VALUE FROM "SERVER_CONFIG" ` +
	...
	// queryDeleteServerConfig deletes a server config by name.
	queryDeleteServerConfig = dbmodel.DBQuery{
		ID: "SCF-04",
