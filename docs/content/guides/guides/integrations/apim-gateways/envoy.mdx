...
Complete the [scope-based authorization configuration](#configure-scope-based-authorization-in-envoy) before you continue. The AuthZEN PDP evaluates the same Resource Server, Resource, Action, permission, and role assignments.
