...
describe('NamespaceSelector', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders the helper text', () => {
      ...
      expect(screen.getByText('A namespace typically represents a page or a section within a page. It helps group and organize related translation keys for better structure and maintainability.')).toBeInTheDocument();
    });
