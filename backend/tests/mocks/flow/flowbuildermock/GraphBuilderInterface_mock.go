...
func (_mock *GraphBuilderInterfaceMock) GetGraph(ctx context.Context, flow *common.CompleteFlowDefinition) (core.GraphInterface, *serviceerror.ServiceError) {
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, *common.CompleteFlowDefinition) (core.GraphInterface, *serviceerror.ServiceError)); ok {
		return returnFunc(ctx, flow)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *common.CompleteFlowDefinition) core.GraphInterface); ok {
...
func (_c *GraphBuilderInterfaceMock_GetGraph_Call) RunAndReturn(run func(ctx context.Context, flow *common.CompleteFlowDefinition) (core.GraphInterface, *serviceerror.ServiceError)) *GraphBuilderInterfaceMock_GetGraph_Call {
	_c.Call.Return(run)
	return _c
}
