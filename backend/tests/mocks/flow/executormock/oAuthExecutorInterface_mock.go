...
func (_mock *oAuthExecutorInterfaceMock) ResolveContextUser(ctx *core.NodeContext, execResp *common.ExecutorResponse, sub string, internalUser *entityprovider.Entity, isAmbiguous bool) error {
...
func (_c *oAuthExecutorInterfaceMock_ResolveContextUser_Call) Return(err error) *oAuthExecutorInterfaceMock_ResolveContextUser_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *oAuthExecutorInterfaceMock_ResolveContextUser_Call) RunAndReturn(run func(ctx *core.NodeContext, execResp *common.ExecutorResponse, sub string, internalUser *entityprovider.Entity, isAmbiguous bool) error) *oAuthExecutorInterfaceMock_ResolveContextUser_Call {
	_c.Call.Return(run)
	return _c
}
