...
- [Manage Agents](../../../guides/agents/manage-agents): Model an agent as a protected resource with its own scopes.
- [Agent Authentication](../../../guides/agents/agent-authentication): Configure delegated (on-behalf-of) token issuance and agent client authentication.
