...
func (suite *AuthenticationServiceTestSuite) TestSendOTPSuccess() {
	...
	suite.mockOTPService.On("GenerateOTP", mock.Anything, recipient, "mobileNumber").
...
func (suite *AuthenticationServiceTestSuite) TestSendOTPSendError() {
	...
	svcErr := &serviceerror.ServiceError{
		Type:             serviceerror.ClientErrorType,
		Code:             "SEND_ERROR",
		Error:            core.I18nMessage{Key: "error.test.send_error", DefaultValue: "Send error"},
		ErrorDescription: core.I18nMessage{Key: "error.test.failed_to_send", DefaultValue: "Failed to send"},
	}
