...
func (e *applicationDeleteExecutor) Execute(ctx *providers.NodeContext) (
	*providers.ExecutorResponse, error) {
	...
	if svcErr := e.provider.DeleteApplication(ctx.Context, appID); svcErr != nil {
...
func (e *applicationDeleteExecutor) setApplicationProvider(provider applicationAdminProvider) {
	e.provider = provider
}
