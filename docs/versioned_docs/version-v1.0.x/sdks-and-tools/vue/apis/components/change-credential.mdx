...
docType: reference
description: Lets a signed-in user set a new value for one of their own credentials, such as their password, in Vue apps.
---
...
```vue title="src/AccountPage.vue" showLineNumbers
<script setup>
