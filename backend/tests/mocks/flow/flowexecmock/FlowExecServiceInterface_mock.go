...
func (_mock *FlowExecServiceInterfaceMock) Execute(ctx context.Context, appID string, executionID string, flowType string, verbose bool, action string, inputs map[string]string, challengeToken string, appSecret string) (*flowexec.FlowStep, *common.ServiceError) {
