...
var (
	...
	// include the SCIM tidcommon User schema URN.
	ErrorMissingCoreUserSchema = tidcommon.ServiceError{
		Type: tidcommon.ClientErrorType,
		Code: "SCIM-1004",
		Error: tidcommon.I18nMessage{
			Key:          "error.scim.missing_core_user_schema",
			DefaultValue: "Missing tidcommon User schema",
		},
		ErrorDescription: tidcommon.I18nMessage{
			Key:          "error.scim.missing_core_user_schema_description",
			DefaultValue: "The schemas array must include the SCIM tidcommon User schema URN",
		},
	}
