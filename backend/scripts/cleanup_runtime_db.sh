...
#   3. WEBAUTHN_SESSION
#   4. CIBA_AUTH_REQUEST
#   5. OPENID4VP_REQUEST_STATE
#   6. OPENID4VCI_NONCE
#   7. OPENID4VCI_CREDENTIAL_OFFER
#   8. RUNTIME_STORE
#
# Usage examples:
...
# Tables to clean
TABLES=("WEBAUTHN_SESSION" "OPENID4VP_REQUEST_STATE" "OPENID4VCI_NONCE" "OPENID4VCI_CREDENTIAL_OFFER" "RUNTIME_STORE")
