...
When prompted for a version rule, select **Up to Next Major Version** starting at the [latest release tag](https://github.com/thunder-id/ios-sdks/releases). When prompted to choose package products, select **ThunderIDSwiftUI**. This includes the core `ThunderID` client as a dependency.
