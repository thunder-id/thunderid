...
- [Create and Manage Your Agent](../../../guides/agents/manage-agents): Register a governed agent identity with an owner, an organization unit, and OAuth credentials, and manage its lifecycle.
- [Authenticate Your Agent](../../../guides/agents/authentication): Configure the credentials an agent uses and rotate them without downtime.
