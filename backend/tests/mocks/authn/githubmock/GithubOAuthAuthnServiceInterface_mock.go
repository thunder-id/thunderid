...
func (_mock *GithubOAuthAuthnServiceInterfaceMock) GetInternalUser(ctx context.Context, sub string) (*entityprovider.Entity, *serviceerror.ServiceError) {
...
func (_c *GithubOAuthAuthnServiceInterfaceMock_GetInternalUser_Call) RunAndReturn(run func(ctx context.Context, sub string) (*entityprovider.Entity, *serviceerror.ServiceError)) *GithubOAuthAuthnServiceInterfaceMock_GetInternalUser_Call {
	_c.Call.Return(run)
	return _c
}
