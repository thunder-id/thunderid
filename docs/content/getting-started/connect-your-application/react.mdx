...
<CodeGroup>
  ...
  <CodeBlock lang="bash" label="Deno">
    deno run -A npm:create-vite@latest my-react-app --template react
    cd my-react-app
    deno install
  </CodeBlock>
</CodeGroup>
...
<NextSteps>
  ...
  <NextStepsCard title="React SDK Reference" href="../../../sdks-and-tools/react/overview" description="Explore the full API reference for the React SDK." cta="API Reference" />
</NextSteps>
