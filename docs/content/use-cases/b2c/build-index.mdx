...
7. **[Keep Them Signed In](../build-sessions)** adds the session checkpoint, so a return trip skips the sign-in screen.
8. **[Sign Them Out](../build-signout)** ends the sign-in at <ProductName />, not just in the application.
