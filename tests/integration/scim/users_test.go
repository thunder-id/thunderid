...
// TestSCIMUsersTestSuite tests SCIM Users Test Suite.
...
// TestCreateAndGetUser tests Create And Get User.
...
// TestListAndFilterByEmail tests List And Filter By Email.
...
// everyone else in it.
// TestListUsersSkipsUserWithOrphanedType tests List Users Skips User With Orphaned Type.
func (ts *SCIMUsersTestSuite) TestListUsersSkipsUserWithOrphanedType() {
	...
	for startIndex := 1; ; {
		...
		if len(list.Resources) == 0 || len(ids) >= list.TotalResults {
			break
		}
...
// TestReplaceUserUpdatesExtensionAttribute tests Replace User Updates Extension Attribute.
...
// TestMissingRequiredExtensionAttribute tests Missing Required Extension Attribute.
...
// TestDuplicateEmailConflict tests Duplicate Email Conflict.
...
// TestGetUnknownUserReturns404 tests Get Unknown User Returns 404.
...
// TestDeleteUserThenGetReturns404 tests Delete User Then Get Returns 404.
...
// TestCreateUserWrongContentTypeRejected tests Create User Wrong Content Type Rejected.
...
// TestCreateUserMalformedJSONRejected tests Create User Malformed JSON Rejected.
...
// TestCreateUserMissingSchemasRejected tests Create User Missing Schemas Rejected.
...
// TestCreateUserDuplicateSchemaURNsRejected tests Create User Duplicate Schema UR Ns Rejected.
...
// TestCreateUserTwoExtensionURNsRejected tests Create User Two Extension UR Ns Rejected.
...
// TestCreateUserUndeclaredAttributeRejected tests Create User Undeclared Attribute Rejected.
...
// TestCreateUserInvalidStringEnumRejected tests Create User Invalid String Enum Rejected.
...
// TestCreateUserInvalidNumberEnumRejected tests Create User Invalid Number Enum Rejected.
...
// TestReplaceUserImmutableTypeChangeRejected tests Replace User Immutable Type Change Rejected.
...
// TestReplaceUserIfMatchMismatchRejected tests Replace User If Match Mismatch Rejected.
...
// TestGetUserAttributesProjection tests Get User Attributes Projection.
...
// TestGetUserExcludedAttributesProjection tests Get User Excluded Attributes Projection.
