...
The `ThunderIDRoot` component is the root provider for the <ProductName /> Nuxt SDK. It mounts the full provider tree, including i18n, branding, theme, flow, user, and organization, and must wrap all content that uses <ProductName /> composables or components.
