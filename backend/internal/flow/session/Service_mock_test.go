...
func (_mock *ServiceMock) SetTerminationListener(listener TerminationListener) {
...
func (_c *ServiceMock_SetTerminationListener_Call) Run(run func(listener TerminationListener)) *ServiceMock_SetTerminationListener_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 TerminationListener
		if args[0] != nil {
			arg0 = args[0].(TerminationListener)
		}
		run(
			arg0,
		)
...
func (_c *ServiceMock_SetTerminationListener_Call) RunAndReturn(run func(listener TerminationListener)) *ServiceMock_SetTerminationListener_Call {
	_c.Run(run)
	return _c
}
