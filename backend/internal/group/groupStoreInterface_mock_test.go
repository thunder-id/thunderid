...
func (_mock *groupStoreInterfaceMock) GetGroupsByNames(ctx context.Context, names []string) ([]GroupBasicDAO, error) {
...
func (_c *groupStoreInterfaceMock_GetGroupsByNames_Call) Return(groupBasicDAOs []GroupBasicDAO, err error) *groupStoreInterfaceMock_GetGroupsByNames_Call {
	_c.Call.Return(groupBasicDAOs, err)
	return _c
}

func (_c *groupStoreInterfaceMock_GetGroupsByNames_Call) RunAndReturn(run func(ctx context.Context, names []string) ([]GroupBasicDAO, error)) *groupStoreInterfaceMock_GetGroupsByNames_Call {
	_c.Call.Return(run)
	return _c
}
