...
// SchemaBuilderTestSuite groups the tests in schema_builder_test.go.
type SchemaBuilderTestSuite struct {
	suite.Suite
}

// TestSchemaBuilderTestSuite runs SchemaBuilderTestSuite.
func TestSchemaBuilderTestSuite(t *testing.T) {
	suite.Run(t, new(SchemaBuilderTestSuite))
}
...
func (suite *SchemaBuilderTestSuite) TestMapRawPropertyToSCIMAttribute_CredentialArrayItems_PropagatesNeverReturned() {
	t := suite.T()
