...
func (_mock *EntityTypeServiceInterfaceMock) GetEntityTypeUsages(ctx context.Context, category entitytype.TypeCategory, schemaID string) (*resourcedependency.DependenciesResponse, *common.ServiceError) {
	ret := _mock.Called(ctx, category, schemaID)
	...
	var r1 *common.ServiceError
	if returnFunc, ok := ret.Get(0).(func(context.Context, entitytype.TypeCategory, string) (*resourcedependency.DependenciesResponse, *common.ServiceError)); ok {
		return returnFunc(ctx, category, schemaID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, entitytype.TypeCategory, string) *resourcedependency.DependenciesResponse); ok {
		r0 = returnFunc(ctx, category, schemaID)
	} else {
		if ret.Get(0) != nil {
...
func (_c *EntityTypeServiceInterfaceMock_GetEntityTypeUsages_Call) Run(run func(ctx context.Context, category entitytype.TypeCategory, schemaID string)) *EntityTypeServiceInterfaceMock_GetEntityTypeUsages_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *EntityTypeServiceInterfaceMock_GetEntityTypeUsages_Call) RunAndReturn(run func(ctx context.Context, category entitytype.TypeCategory, schemaID string) (*resourcedependency.DependenciesResponse, *common.ServiceError)) *EntityTypeServiceInterfaceMock_GetEntityTypeUsages_Call {
	_c.Call.Return(run)
	return _c
}
