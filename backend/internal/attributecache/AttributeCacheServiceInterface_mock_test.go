...
func (_mock *AttributeCacheServiceInterfaceMock) CreateAttributeCache(ctx context.Context, cache *AttributeCache) (*AttributeCache, *common.ServiceError) {
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, *AttributeCache) (*AttributeCache, *common.ServiceError)); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, *AttributeCache) *common.ServiceError); ok {
...
func (_c *AttributeCacheServiceInterfaceMock_CreateAttributeCache_Call) Return(attributeCache *AttributeCache, serviceError *common.ServiceError) *AttributeCacheServiceInterfaceMock_CreateAttributeCache_Call {
	_c.Call.Return(attributeCache, serviceError)
	return _c
}

func (_c *AttributeCacheServiceInterfaceMock_CreateAttributeCache_Call) RunAndReturn(run func(ctx context.Context, cache *AttributeCache) (*AttributeCache, *common.ServiceError)) *AttributeCacheServiceInterfaceMock_CreateAttributeCache_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *AttributeCacheServiceInterfaceMock) GetAttributeCache(ctx context.Context, id string) (*AttributeCache, *common.ServiceError) {
	ret := _mock.Called(ctx, id)
	...
	var r0 *AttributeCache
	var r1 *common.ServiceError
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (*AttributeCache, *common.ServiceError)); ok {
...
func (_c *AttributeCacheServiceInterfaceMock_GetAttributeCache_Call) Return(attributeCache *AttributeCache, serviceError *common.ServiceError) *AttributeCacheServiceInterfaceMock_GetAttributeCache_Call {
	_c.Call.Return(attributeCache, serviceError)
	return _c
}

func (_c *AttributeCacheServiceInterfaceMock_GetAttributeCache_Call) RunAndReturn(run func(ctx context.Context, id string) (*AttributeCache, *common.ServiceError)) *AttributeCacheServiceInterfaceMock_GetAttributeCache_Call {
	_c.Call.Return(run)
	return _c
}
