...
5. **[Customize Notifications](../build-notifications)** tailors the email and SMS content those flows send.
6. **[Register the Application](../build-application)** registers the OAuth2 client that runs them.
