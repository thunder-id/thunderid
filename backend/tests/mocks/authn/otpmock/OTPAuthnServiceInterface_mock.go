...
func (_mock *OTPAuthnServiceInterfaceMock) GenerateOTP(ctx context.Context, recipient string, recipientAttr string) (string, string, int64, *serviceerror.ServiceError) {
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string) (string, string, int64, *serviceerror.ServiceError)); ok {
	...
	if returnFunc, ok := ret.Get(3).(func(context.Context, string, string) *serviceerror.ServiceError); ok {
...
func (_c *OTPAuthnServiceInterfaceMock_GenerateOTP_Call) Return(sessionToken string, otpValue string, expirySeconds int64, svcErr *serviceerror.ServiceError) *OTPAuthnServiceInterfaceMock_GenerateOTP_Call {
	_c.Call.Return(sessionToken, otpValue, expirySeconds, svcErr)
	return _c
}

func (_c *OTPAuthnServiceInterfaceMock_GenerateOTP_Call) RunAndReturn(run func(ctx context.Context, recipient string, recipientAttr string) (string, string, int64, *serviceerror.ServiceError)) *OTPAuthnServiceInterfaceMock_GenerateOTP_Call {
	_c.Call.Return(run)
	return _c
}
