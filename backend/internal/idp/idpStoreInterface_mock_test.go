...
func (_mock *idpStoreInterfaceMock) UpdateIdentityProvider(ctx context.Context, idp *providers.IDPDTO) error {
	ret := _mock.Called(ctx, idp)
...
func (_c *idpStoreInterfaceMock_UpdateIdentityProvider_Call) Run(run func(ctx context.Context, idp *providers.IDPDTO)) *idpStoreInterfaceMock_UpdateIdentityProvider_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *idpStoreInterfaceMock_UpdateIdentityProvider_Call) RunAndReturn(run func(ctx context.Context, idp *providers.IDPDTO) error) *idpStoreInterfaceMock_UpdateIdentityProvider_Call {
	_c.Call.Return(run)
	return _c
}
