...
func (_mock *EntityTypeServiceInterfaceMock) GetSelfUserTypeSchema(ctx context.Context, category TypeCategory, userTypeName string) (*EntityType, *common.ServiceError) {
...
func (_c *EntityTypeServiceInterfaceMock_GetSelfUserTypeSchema_Call) Run(run func(ctx context.Context, category TypeCategory, userTypeName string)) *EntityTypeServiceInterfaceMock_GetSelfUserTypeSchema_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *EntityTypeServiceInterfaceMock_GetSelfUserTypeSchema_Call) Return(entityType *EntityType, serviceError *common.ServiceError) *EntityTypeServiceInterfaceMock_GetSelfUserTypeSchema_Call {
	_c.Call.Return(entityType, serviceError)
	return _c
}

func (_c *EntityTypeServiceInterfaceMock_GetSelfUserTypeSchema_Call) RunAndReturn(run func(ctx context.Context, category TypeCategory, userTypeName string) (*EntityType, *common.ServiceError)) *EntityTypeServiceInterfaceMock_GetSelfUserTypeSchema_Call {
	_c.Call.Return(run)
	return _c
}
