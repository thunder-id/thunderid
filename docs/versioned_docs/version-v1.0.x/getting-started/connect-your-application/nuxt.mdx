...
<NextSteps>
  ...
  <NextStepsCard title="Nuxt SDK Reference" href="../../../sdks-and-tools/nuxt/overview" description="Explore the full API reference for the Nuxt SDK." cta="API Reference" />
</NextSteps>
