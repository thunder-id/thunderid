...
var validInputTypes = map[string]bool{
	common.InputTypeText:     true,
	common.InputTypeEmail:    true,
	common.InputTypePassword: true,
	common.InputTypeOTP:      true,
	common.InputTypePhone:    true,
	common.InputTypeConsent:  true,
	common.InputTypeHidden:   true,
	common.InputTypeSelect:   true,
	common.InputTypeOUSelect: true,
}
...
func validateInputDefinitions(nodeID string, inputs []providers.InputDefinition) *tidcommon.ServiceError {
	for _, input := range inputs {
		...
		for _, rule := range input.Validation {
			if !common.ValidValidationRuleTypes[rule.Type] {
