...
-- Prefix matching falls back to a scan over the small, admin-managed member set here.
CREATE INDEX idx_rsporm_prefix ON "RESOURCE_SHARING_POLICY_OVERLAY_RULE_MEMBER" (MEMBER_KEY);
