...
func (_mock *FlowMgtServiceInterfaceMock) GetFlowsMeta(fields []string) *flowmgt.FlowsMeta {
	...
	var r0 *flowmgt.FlowsMeta
	if returnFunc, ok := ret.Get(0).(func([]string) *flowmgt.FlowsMeta); ok {
		r0 = returnFunc(fields)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*flowmgt.FlowsMeta)
		}
	}
	return r0
}
...
func (_c *FlowMgtServiceInterfaceMock_GetFlowsMeta_Call) Return(flowsMeta *flowmgt.FlowsMeta) *FlowMgtServiceInterfaceMock_GetFlowsMeta_Call {
	_c.Call.Return(flowsMeta)
	return _c
}

func (_c *FlowMgtServiceInterfaceMock_GetFlowsMeta_Call) RunAndReturn(run func(fields []string) *flowmgt.FlowsMeta) *FlowMgtServiceInterfaceMock_GetFlowsMeta_Call {
	_c.Call.Return(run)
	return _c
}
