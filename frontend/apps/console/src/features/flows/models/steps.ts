...
export const ExecutionTypes = {
  ...
  CriteriaRevocationRestamp: 'CriteriaRevocationRestampExecutor',
  PreRoleAssignmentRemoval: 'PreRoleAssignmentRemovalExecutor',
  RoleAssignmentRemoval: 'RoleAssignmentRemovalExecutor',
  PreRoleDeletion: 'PreRoleDeletionExecutor',
  RoleDeletion: 'RoleDeletionExecutor',
  PreRolePermissionRemoval: 'PreRolePermissionRemovalExecutor',
  RolePermissionRemoval: 'RolePermissionRemovalExecutor',
  PreGroupDeletion: 'PreGroupDeletionExecutor',
  GroupDeletion: 'GroupDeletionExecutor',
  PreGroupMembershipRemoval: 'PreGroupMembershipRemovalExecutor',
  GroupMembershipRemoval: 'GroupMembershipRemovalExecutor',
  PreScopeDeletion: 'PreScopeDeletionExecutor',
  ScopeDeletion: 'ScopeDeletionExecutor',
