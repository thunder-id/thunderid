...
// FilterTestSuite groups the tests in filter_test.go.
type FilterTestSuite struct {
	suite.Suite
}

// TestFilterTestSuite runs FilterTestSuite.
...
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_EmptyString_ReturnsNil() {
	t := suite.T()
...
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_UnsupportedOperator_ReturnsError() {
	t := suite.T()
	tests := []string{
		`userName ne "alice"`,
		`userName co "ali"`,
...
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_AttributeNamePrefixedWithOperatorLetters_Accepted() {
	t := suite.T()
...
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_PathSegmentMatchingOperator_Accepted() {
	t := suite.T()
...
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_MalformedExpression_ReturnsError() {
	t := suite.T()
...
// Value Returns Error.
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_InvalidCompValue_ReturnsError() {
	t := suite.T()
...
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_CompoundAnd_DuplicateAttribute_ReturnsError() {
	t := suite.T()
...
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_CompoundAnd_MalformedSecondClause_ReturnsError() {
	t := suite.T()
...
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_Or_StillUnsupported() {
	t := suite.T()
...
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_Not_StillUnsupported() {
	t := suite.T()
...
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_Grouping_StillUnsupported() {
	t := suite.T()
...
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_CustomAttrWithoutURN_ReturnsError() {
	t := suite.T()
...
// URN Accepted.
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_CustomAttrWithURN_Accepted() {
	t := suite.T()
	filters, svcErr := ParseSCIMFilterForEq(
...
// URN Accepted.
func (suite *FilterTestSuite) TestParseSCIMFilterForEq_CoreAttrWithoutURN_Accepted() {
	t := suite.T()
...
func (suite *FilterTestSuite) TestParseSCIMCompValue() {
	t := suite.T()
	tests := []struct {
		name      string
		raw       string
