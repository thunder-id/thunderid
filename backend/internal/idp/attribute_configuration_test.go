...
type AttributeConfigurationTestSuite struct {
	suite.Suite
	mockET     *entitytypemock.EntityTypeServiceInterfaceMock
	idpService *idpService
}

func TestAttributeConfigurationTestSuite(t *testing.T) {
	suite.Run(t, new(AttributeConfigurationTestSuite))
}

func (s *AttributeConfigurationTestSuite) SetupTest() {
	s.mockET = entitytypemock.NewEntityTypeServiceInterfaceMock(s.T())
	s.idpService = &idpService{entityTypeService: s.mockET}
}
...
func (s *AttributeConfigurationTestSuite) TestValidateAttributeConfiguration_NilMapping_OK() {
	svcErr := s.idpService.validateAttributeConfiguration(context.Background(), &IDPDTO{})
	s.Nil(svcErr)
}

func (s *AttributeConfigurationTestSuite) TestValidateAttributeConfiguration_Valid() {
...
func (s *AttributeConfigurationTestSuite) TestValidateAttributeConfiguration_EmptyUserType() {
...
func (s *AttributeConfigurationTestSuite) TestValidateAttributeConfiguration_EmptyMappings() {
	s.mockET.On("GetAttributes", mock.Anything, entitytype.TypeCategoryUser, "person", false, true, false).
...
func (s *AttributeConfigurationTestSuite) TestValidateAttributeConfiguration_OneSourceToMultipleTargets() {
	s.mockET.On("GetAttributes", mock.Anything, entitytype.TypeCategoryUser, "person", false, true, false).
...
func (s *AttributeConfigurationTestSuite) TestValidateAttributeConfiguration_DuplicateTarget() {
	idp := &IDPDTO{AttributeConfiguration: singleProfileMapping("person", []AttributeMapping{
		{ExternalAttribute: "given_name", LocalAttribute: "firstName"},
...
func (s *AttributeConfigurationTestSuite) TestValidateAttributeConfiguration_DuplicateUserType() {
	s.mockET.On("GetAttributes", mock.Anything, entitytype.TypeCategoryUser, "person", false, true, false).
		Return([]entitytype.AttributeInfo{{Attribute: "firstName"}}, (*serviceerror.ServiceError)(nil))
	idp := &IDPDTO{AttributeConfiguration: &AttributeConfiguration{
...
func (s *AttributeConfigurationTestSuite) TestValidateAttributeConfiguration_TargetNotInSchema() {
	s.mockET.On("GetAttributes", mock.Anything, entitytype.TypeCategoryUser, "person", false, true, false).
...
func (s *AttributeConfigurationTestSuite) TestValidateAttributeConfiguration_UnknownUserType() {
