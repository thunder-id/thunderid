...
2. Enter a name (e.g. `My Node.js App`) and click **Create**
3. Under **Protocol**, set the **Allowed Redirect URI** to `http://localhost:3000/callback`
4. Copy both the **Client ID** and **Client Secret**. You'll need them when configuring the SDK
