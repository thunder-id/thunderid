...
func (_c *OIDCAuthnServiceInterfaceMock_Authenticate_Call) Return(authnResult *common.AuthnResult, serviceError *common0.ServiceError) *OIDCAuthnServiceInterfaceMock_Authenticate_Call {
...
func (_c *OIDCAuthnServiceInterfaceMock_ExchangeCodeForToken_Call) Return(tokenResponse *oauth.TokenResponse, serviceError *common0.ServiceError) *OIDCAuthnServiceInterfaceMock_ExchangeCodeForToken_Call {
	_c.Call.Return(tokenResponse, serviceError)
	return _c
}

func (_c *OIDCAuthnServiceInterfaceMock_ExchangeCodeForToken_Call) RunAndReturn(run func(ctx context.Context, idpID string, code string, validateResponse bool) (*oauth.TokenResponse, *common0.ServiceError)) *OIDCAuthnServiceInterfaceMock_ExchangeCodeForToken_Call {
	_c.Call.Return(run)
	return _c
}

// FetchUserInfo provides a mock function for the type OIDCAuthnServiceInterfaceMock
func (_mock *OIDCAuthnServiceInterfaceMock) FetchUserInfo(ctx context.Context, idpID string, accessToken string) (map[string]interface{}, *common0.ServiceError) {
...
func (_c *OIDCAuthnServiceInterfaceMock_FetchUserInfo_Call) Return(stringToIfaceVal map[string]interface{}, serviceError *common0.ServiceError) *OIDCAuthnServiceInterfaceMock_FetchUserInfo_Call {
	_c.Call.Return(stringToIfaceVal, serviceError)
	return _c
}

func (_c *OIDCAuthnServiceInterfaceMock_FetchUserInfo_Call) RunAndReturn(run func(ctx context.Context, idpID string, accessToken string) (map[string]interface{}, *common0.ServiceError)) *OIDCAuthnServiceInterfaceMock_FetchUserInfo_Call {
	_c.Call.Return(run)
	return _c
}

// GetIDTokenClaims provides a mock function for the type OIDCAuthnServiceInterfaceMock
func (_mock *OIDCAuthnServiceInterfaceMock) GetIDTokenClaims(ctx context.Context, idToken string) (map[string]interface{}, *common0.ServiceError) {
...
func (_c *OIDCAuthnServiceInterfaceMock_GetIDTokenClaims_Call) Return(stringToIfaceVal map[string]interface{}, serviceError *common0.ServiceError) *OIDCAuthnServiceInterfaceMock_GetIDTokenClaims_Call {
	_c.Call.Return(stringToIfaceVal, serviceError)
	return _c
}

func (_c *OIDCAuthnServiceInterfaceMock_GetIDTokenClaims_Call) RunAndReturn(run func(ctx context.Context, idToken string) (map[string]interface{}, *common0.ServiceError)) *OIDCAuthnServiceInterfaceMock_GetIDTokenClaims_Call {
	_c.Call.Return(run)
	return _c
}

// GetOAuthClientConfig provides a mock function for the type OIDCAuthnServiceInterfaceMock
func (_mock *OIDCAuthnServiceInterfaceMock) GetOAuthClientConfig(ctx context.Context, idpID string) (*oauth.OAuthClientConfig, *common0.ServiceError) {
	ret := _mock.Called(ctx, idpID)
...
func (_c *OIDCAuthnServiceInterfaceMock_GetOAuthClientConfig_Call) Return(oAuthClientConfig *oauth.OAuthClientConfig, serviceError *common0.ServiceError) *OIDCAuthnServiceInterfaceMock_GetOAuthClientConfig_Call {
	_c.Call.Return(oAuthClientConfig, serviceError)
	return _c
}

func (_c *OIDCAuthnServiceInterfaceMock_GetOAuthClientConfig_Call) RunAndReturn(run func(ctx context.Context, idpID string) (*oauth.OAuthClientConfig, *common0.ServiceError)) *OIDCAuthnServiceInterfaceMock_GetOAuthClientConfig_Call {
	_c.Call.Return(run)
	return _c
}

// ValidateIDToken provides a mock function for the type OIDCAuthnServiceInterfaceMock
func (_mock *OIDCAuthnServiceInterfaceMock) ValidateIDToken(ctx context.Context, idpID string, idToken string) *common0.ServiceError {
...
func (_c *OIDCAuthnServiceInterfaceMock_ValidateIDToken_Call) Return(serviceError *common0.ServiceError) *OIDCAuthnServiceInterfaceMock_ValidateIDToken_Call {
	_c.Call.Return(serviceError)
	return _c
}

func (_c *OIDCAuthnServiceInterfaceMock_ValidateIDToken_Call) RunAndReturn(run func(ctx context.Context, idpID string, idToken string) *common0.ServiceError) *OIDCAuthnServiceInterfaceMock_ValidateIDToken_Call {
	_c.Call.Return(run)
	return _c
}

// ValidateTokenResponse provides a mock function for the type OIDCAuthnServiceInterfaceMock
func (_mock *OIDCAuthnServiceInterfaceMock) ValidateTokenResponse(ctx context.Context, idpID string, tokenResp *oauth.TokenResponse, validateIDToken bool) *common0.ServiceError {
	...
	var r0 *common0.ServiceError
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, *oauth.TokenResponse, bool) *common0.ServiceError); ok {
...
func (_c *OIDCAuthnServiceInterfaceMock_ValidateTokenResponse_Call) Return(serviceError *common0.ServiceError) *OIDCAuthnServiceInterfaceMock_ValidateTokenResponse_Call {
	_c.Call.Return(serviceError)
	return _c
}

func (_c *OIDCAuthnServiceInterfaceMock_ValidateTokenResponse_Call) RunAndReturn(run func(ctx context.Context, idpID string, tokenResp *oauth.TokenResponse, validateIDToken bool) *common0.ServiceError) *OIDCAuthnServiceInterfaceMock_ValidateTokenResponse_Call {
	_c.Call.Return(run)
	return _c
}
