...
describe('SimulationStepPreview', () => {
  ...
  it('should render the view components as an end-user screen', () => {
    ...
    expect(screen.getByText('Sign In', {selector: 'h5'})).toBeInTheDocument();
  ...
  it('should label the camera toggle as follow when in static view', () => {
    ...
    expect(screen.getByRole('button', {name: 'Follow steps on the canvas'})).toHaveAttribute('aria-pressed', 'false');
  });
