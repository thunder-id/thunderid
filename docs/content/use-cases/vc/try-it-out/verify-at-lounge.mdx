...
- Want the full protocol detail? The [OpenID for Verifiable Presentations](../../../../guides/guides/protocols/openid4vc/openid4vp) guide covers the presentation request, response token, and SD-JWT VC verification.
