...
- [Create and Manage Your Agent](../../../guides/agents/manage-agents): Register an agent with its own identity, owner, and lifecycle.
- [Act on Behalf of a User](../../../guides/agents/authentication/on-behalf-of-user): Configure delegated (on-behalf-of) token issuance.
