...
func (s *flowInferenceService) cloneNodes(nodes []common.NodeDefinition) ([]common.NodeDefinition, error) {
	...
	var clonedNodes []common.NodeDefinition
...
func (s *flowInferenceService) cleanAuthenticationProperties(nodes []common.NodeDefinition) {
	for i := range nodes {
		node := &nodes[i]
...
func (s *flowInferenceService) cleanPromptNodeMeta(node *common.NodeDefinition) {
...
func (s *flowInferenceService) findStartNode(nodes []common.NodeDefinition) (string, error) {
...
func (s *flowInferenceService) findEndNode(nodes []common.NodeDefinition) (string, error) {
	for _, node := range nodes {
...
func (s *flowInferenceService) hasLayoutInformation(nodes []common.NodeDefinition) bool {
	for _, node := range nodes {
...
func (s *flowInferenceService) addDefaultLayout(node *common.NodeDefinition) {
	node.Layout = &common.NodeLayout{
		Size: &common.NodeSize{
			Width:  defaultNodeWidth,
			Height: defaultNodeHeight,
		},
		Position: &common.NodePosition{
			X: defaultNodeXPos,
			Y: defaultNodeYPos,
		},
	}
...
func (s *flowInferenceService) findAuthAssertNode(nodes []common.NodeDefinition) (string, bool) {
	for _, node := range nodes {
...
func (s *flowInferenceService) hasProvisioningNode(nodes []common.NodeDefinition) bool {
	for _, node := range nodes {
...
func (s *flowInferenceService) insertProvisioningNode(nodes *[]common.NodeDefinition, includeLayout bool) error {
...
func (s *flowInferenceService) createProvisioningNode(nextNodeID string, includeLayout bool) common.NodeDefinition {
	node := common.NodeDefinition{
...
func (s *flowInferenceService) hasUserTypeResolverNode(nodes []common.NodeDefinition) bool {
	for _, node := range nodes {
...
func (s *flowInferenceService) createUserTypePromptNode(nextNodeID string, includeLayout bool) common.NodeDefinition {
	node := common.NodeDefinition{
...
func (s *flowInferenceService) createInputPromptNode(nodeID string, input common.Input,
	nextNodeID string, includeLayout bool) common.NodeDefinition {
...
func (s *flowInferenceService) insertPhoneInputPromptIfNeeded(nodes *[]common.NodeDefinition, includeLayout bool) {
...
func (s *flowInferenceService) insertNodeBefore(nodes *[]common.NodeDefinition,
	newNode common.NodeDefinition, targetNodeID string) error {
	modified := false
	for i := range *nodes {
		node := &(*nodes)[i]
...
func (s *flowInferenceService) insertNodeAfterStart(nodes *[]common.NodeDefinition,
	newNode common.NodeDefinition, startNodeID string) error {
