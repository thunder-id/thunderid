...
func (_mock *flowStoreInterfaceMock) CreateFlow(ctx context.Context, flowID string, flow *flowmgt.FlowDefinition) (*common.CompleteFlowDefinition, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, *flowmgt.FlowDefinition) (*common.CompleteFlowDefinition, error)); ok {
...
func (_c *flowStoreInterfaceMock_CreateFlow_Call) RunAndReturn(run func(ctx context.Context, flowID string, flow *flowmgt.FlowDefinition) (*common.CompleteFlowDefinition, error)) *flowStoreInterfaceMock_CreateFlow_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *flowStoreInterfaceMock) UpdateFlow(ctx context.Context, flowID string, flow *flowmgt.FlowDefinition) (*common.CompleteFlowDefinition, error) {
	ret := _mock.Called(ctx, flowID, flow)
...
func (_c *flowStoreInterfaceMock_UpdateFlow_Call) RunAndReturn(run func(ctx context.Context, flowID string, flow *flowmgt.FlowDefinition) (*common.CompleteFlowDefinition, error)) *flowStoreInterfaceMock_UpdateFlow_Call {
	_c.Call.Return(run)
	return _c
}
