...
const translations = {
  ...
  flows: {
    ...
    // Capability catalog
    'catalog.title': 'What do you want to build?',
    'catalog.subtitle': 'Explore ready-made capabilities and start from a template',
    'catalog.explore': 'Explore what you can build',
    'catalog.templatesCount_one': '{{count}} template',
    'catalog.templatesCount_other': '{{count}} templates',
    'catalog.cards.passwords.title': 'Passwords & Credentials',
    'catalog.cards.passwords.description': 'Classic sign-in and registration with username and password',
    'catalog.cards.socialLogin.title': 'Social & Enterprise Login',
    'catalog.cards.socialLogin.description': 'Let users continue with Google, GitHub, or any OAuth/OIDC provider',
    'catalog.cards.mfa.title': 'Multi-Factor Authentication',
    'catalog.cards.mfa.description': 'Add a second factor with SMS or email one-time passcodes',
    'catalog.cards.passwordless.title': 'Passwordless',
    'catalog.cards.passwordless.description': 'Sign in with passkeys, magic links, or digital wallets',
    'catalog.cards.recovery.title': 'Account Recovery',
    'catalog.cards.recovery.description': 'Help users reset passwords and regain access to their accounts',
