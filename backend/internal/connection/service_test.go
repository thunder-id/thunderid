...
func (s *testAuthZENPDPStore) CreateAuthZENPDP(
	_ context.Context, connection authzenpdp.AuthZENPDPConnection,
) error {
	s.connections[connection.ID] = connection
	return nil
}

func (s *testAuthZENPDPStore) ListAuthZENPDPs(
	_ context.Context,
...
func (s *testAuthZENPDPStore) GetAuthZENPDP(
...
func (s *testAuthZENPDPStore) GetAuthZENPDPByName(_ context.Context,
...
func (s *testAuthZENPDPStore) UpdateAuthZENPDP(_ context.Context, id string,
...
func (s *testAuthZENPDPStore) DeleteAuthZENPDP(_ context.Context, id string) error {
...
func (s *ServiceTestSuite) SetupTest() {
	...
	s.svc = newService(s.mockIDP, s.mockNotif, &testResourceServerLister{},
		authzenpdp.NewAuthZENPDPService(newTestAuthZENPDPStore(), config.AuthZENPDPConfig{}))
}
...
func (s *ServiceTestSuite) TestCreateAuthZENPDPStoresConfiguredEndpoints() {
	...
	s.svc = newService(s.mockIDP, s.mockNotif, &testResourceServerLister{},
		authzenpdp.NewAuthZENPDPService(store, config.AuthZENPDPConfig{}))
