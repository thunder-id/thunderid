...
// Initialize initializes the token revocation handler and registers its routes.
func Initialize(
	mux *http.ServeMux,
	...
	revocationService := newRevocationService(jwtService, newRevokedTokenWriter(), observabilitySvc)
