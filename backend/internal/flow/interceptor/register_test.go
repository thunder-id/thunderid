...
func (s *InterceptorRegistryTestSuite) TestregisterInterceptor_Successful() {
	ic := &stubInterceptor{name: "TestIC",
...
func (s *InterceptorRegistryTestSuite) TestregisterInterceptor_Duplicate() {
	ic1 := &stubInterceptor{name: "TestIC",
		isDefault: true, priority: 100}
	ic2 := &stubInterceptor{name: "TestIC",
...
func (s *InterceptorRegistryTestSuite) TestregisterInterceptors_EmptyList_RegistersAllBuiltIn() {
	registry := newInterceptorRegistry()
	deps := InterceptorDependencies{FlowFactory: &stubFlowFactory{}}
...
func (s *InterceptorRegistryTestSuite) TestregisterInterceptors_RegistryNotUpdated_ReturnsError() {
	...
	err := registerInterceptors(deps, mock, []string{ChallengeTokenInterceptor})
...
// stubInterceptor is a minimal test implementation of InterceptorInterface.
...
// noOpRegistry is a registry that silently discards registrations, used to test the
// post-registration verification path.
type noOpRegistry struct{}

func (r *noOpRegistry) RegisterInterceptor(string, core.InterceptorInterface) {}
func (r *noOpRegistry) GetInterceptor(string) (core.InterceptorInterface, error) {
	return nil, nil
}
func (r *noOpRegistry) IsRegistered(string) bool { return false }
