...
func (suite *AuthenticationHandlerTestSuite) TestHandleSendSMSOTPRequestSuccess() {
	...
	suite.mockService.On("SendOTP", mock.Anything, otpRequest.SenderID, mock.Anything,
...
func (suite *AuthenticationHandlerTestSuite) TestHandleSendSMSOTPRequestServiceError() {
	...
	suite.mockService.On("SendOTP", mock.Anything, mock.Anything, mock.Anything,
		mock.Anything, mock.Anything).Return("", serviceError)
