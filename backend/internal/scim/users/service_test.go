...
func TestGetUser_SchemaLookupFailure_DoesNotLeakAttributes(t *testing.T) {
	mockUserService := usermock.NewUserServiceInterfaceMock(t)
	mockUserTypeService := entitytypemock.NewEntityTypeServiceInterfaceMock(t)
...
func TestCreateUser_CoreOnly_ConfiguredCoreUserTypeID_ResolvesUnambiguously(t *testing.T) {
	...
	service := newSCIMUsersService(
		...
		scimconfig.SCIMConfig{CoreUserTypeID: "type-employee-id"})
...
func TestMergeReverseMappedAttrs(t *testing.T) {
	testCases := []struct {
		name           string
		extensionAttrs map[string]json.RawMessage
...
func TestMergeReverseMappedAttrs_EnterpriseCase(t *testing.T) {
	testCases := []struct {
		name           string
		extensionAttrs map[string]json.RawMessage
		reverseMapped  map[string]json.RawMessage
...
func TestCreateUser_EnterpriseSchema_Success(t *testing.T) {
	mockUserService := usermock.NewUserServiceInterfaceMock(t)
	mockUserTypeService := entitytypemock.NewEntityTypeServiceInterfaceMock(t)
	service := newSCIMUsersService(
		mockUserService, mockUserTypeService, scimconfig.SCIMConfig{
...
func TestCreateUser_EnterpriseSchema_NotSupportedForNonTargetUserType(t *testing.T) {
	mockUserService := usermock.NewUserServiceInterfaceMock(t)
	mockUserTypeService := entitytypemock.NewEntityTypeServiceInterfaceMock(t)
	service := newSCIMUsersService(
		mockUserService, mockUserTypeService, scimconfig.SCIMConfig{
...
func TestCreateUser_CoreSchema_NotSupportedForNonCoreUserType(t *testing.T) {
	mockUserService := usermock.NewUserServiceInterfaceMock(t)
	mockUserTypeService := entitytypemock.NewEntityTypeServiceInterfaceMock(t)
	service := newSCIMUsersService(
		mockUserService, mockUserTypeService, scimconfig.SCIMConfig{
...
func TestValidateAttributePaths_ConflictingParams(t *testing.T) {
	mockUserService := usermock.NewUserServiceInterfaceMock(t)
	mockUserTypeService := entitytypemock.NewEntityTypeServiceInterfaceMock(t)
	service := newSCIMUsersService(mockUserService, mockUserTypeService, scimconfig.SCIMConfig{})
...
func TestValidateAttributePaths_NoSchemaLookupNeeded(t *testing.T) {
	mockUserService := usermock.NewUserServiceInterfaceMock(t)
	mockUserTypeService := entitytypemock.NewEntityTypeServiceInterfaceMock(t)
	service := newSCIMUsersService(mockUserService, mockUserTypeService, scimconfig.SCIMConfig{})
...
func TestValidateAttributePaths_CustomSchemaURN_Registered(t *testing.T) {
	mockUserService := usermock.NewUserServiceInterfaceMock(t)
	mockUserTypeService := entitytypemock.NewEntityTypeServiceInterfaceMock(t)
	service := newSCIMUsersService(mockUserService, mockUserTypeService, scimconfig.SCIMConfig{})
...
func TestValidateAttributePaths_CustomSchemaURN_Unregistered(t *testing.T) {
	mockUserService := usermock.NewUserServiceInterfaceMock(t)
	mockUserTypeService := entitytypemock.NewEntityTypeServiceInterfaceMock(t)
	service := newSCIMUsersService(mockUserService, mockUserTypeService, scimconfig.SCIMConfig{})
