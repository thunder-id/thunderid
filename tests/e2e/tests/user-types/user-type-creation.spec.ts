 ...
 * User Type E2E Tests
 *
 * Covers the Console's Create User Type wizard (Name -> Properties, in this single
 * organization-unit environment - see UserTypesPage's class doc for why). The user type is
 * created through the UI, verified through the User Types API, and removed via that API
 * afterwards.
 *
