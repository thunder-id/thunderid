...
- Add a new attribute to the `Customer` schema (for example, `seatPreference`) and verify it appears on John's profile page after a refresh. See [User Types](../../../../guides/guides/users/user-types).
