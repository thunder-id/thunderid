...
func (_mock *OTPServiceInterfaceMock) GenerateOTP(ctx context.Context, recipient string, recipientAttr string, otpCfg *OTPConfig) (string, string, int64, *common.ServiceError) {
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, *OTPConfig) (string, string, int64, *common.ServiceError)); ok {
		return returnFunc(ctx, recipient, recipientAttr, otpCfg)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, *OTPConfig) string); ok {
		r0 = returnFunc(ctx, recipient, recipientAttr, otpCfg)
	} else {
		r0 = ret.Get(0).(string)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, string, *OTPConfig) string); ok {
		r1 = returnFunc(ctx, recipient, recipientAttr, otpCfg)
	} else {
		r1 = ret.Get(1).(string)
	}
	if returnFunc, ok := ret.Get(2).(func(context.Context, string, string, *OTPConfig) int64); ok {
		r2 = returnFunc(ctx, recipient, recipientAttr, otpCfg)
	} else {
		r2 = ret.Get(2).(int64)
	}
	if returnFunc, ok := ret.Get(3).(func(context.Context, string, string, *OTPConfig) *common.ServiceError); ok {
...
func (_c *OTPServiceInterfaceMock_GenerateOTP_Call) Run(run func(ctx context.Context, recipient string, recipientAttr string, otpCfg *OTPConfig)) *OTPServiceInterfaceMock_GenerateOTP_Call {
...
func (_c *OTPServiceInterfaceMock_GenerateOTP_Call) RunAndReturn(run func(ctx context.Context, recipient string, recipientAttr string, otpCfg *OTPConfig) (string, string, int64, *common.ServiceError)) *OTPServiceInterfaceMock_GenerateOTP_Call {
	_c.Call.Return(run)
	return _c
}
