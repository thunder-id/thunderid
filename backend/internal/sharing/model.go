...
type MemberValidator interface {
	// ValidateMembers reports whether initiatingOUID may name these members for fieldKey.
	ValidateMembers(ctx context.Context, fieldKey, initiatingOUID string, members []string) error
}
