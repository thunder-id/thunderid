...
type InlineStubEntityTypeService struct {
	OnCreateEntityType func(ctx context.Context, cat TypeCategory, req CreateEntityTypeRequestWithID) (*EntityType, *serviceerror.ServiceError)
	OnUpdateEntityType func(ctx context.Context, cat TypeCategory, id string, req UpdateEntityTypeRequest) (*EntityType, *serviceerror.ServiceError)
	OnGetEntityType    func(ctx context.Context, cat TypeCategory, id string, inc bool) (*EntityType, *serviceerror.ServiceError)
	OnDeleteEntityType func(ctx context.Context, cat TypeCategory, id string) *serviceerror.ServiceError
}

func (s *InlineStubEntityTypeService) CreateEntityType(ctx context.Context, cat TypeCategory, req CreateEntityTypeRequestWithID) (*EntityType, *serviceerror.ServiceError) {
...
func (s *InlineStubEntityTypeService) UpdateEntityType(ctx context.Context, cat TypeCategory, id string, req UpdateEntityTypeRequest) (*EntityType, *serviceerror.ServiceError) {
...
func (s *InlineStubEntityTypeService) GetEntityType(ctx context.Context, cat TypeCategory, id string, inc bool) (*EntityType, *serviceerror.ServiceError) {
...
func (s *InlineStubEntityTypeService) DeleteEntityType(ctx context.Context, cat TypeCategory, id string) *serviceerror.ServiceError {
...
func (s *InlineStubEntityTypeService) GetEntityTypeList(ctx context.Context, cat TypeCategory, limit, offset int, inc bool) (*EntityTypeListResponse, *serviceerror.ServiceError) {
	return &EntityTypeListResponse{Types: []EntityTypeListItem{}}, nil
}

func (s *InlineStubEntityTypeService) GetAttributes(ctx context.Context, cat TypeCategory, id string, f1, f2, f3 bool) ([]AttributeInfo, *serviceerror.ServiceError) {
	return []AttributeInfo{}, nil
}

func (s *InlineStubEntityTypeService) GetDisplayAttributesByNames(ctx context.Context, cat TypeCategory, names []string) (map[string]string, *serviceerror.ServiceError) {
	return map[string]string{}, nil
}

func (s *InlineStubEntityTypeService) GetEntityTypeByName(ctx context.Context, cat TypeCategory, name string) (*EntityType, *serviceerror.ServiceError) {
	return &EntityType{Name: name}, nil
}

func (s *InlineStubEntityTypeService) GetUniqueAttributes(ctx context.Context, cat TypeCategory, name string) ([]string, *serviceerror.ServiceError) {
	return []string{}, nil
}

func (s *InlineStubEntityTypeService) ResolveEntityTypeHandles(ctx context.Context, entityType *EntityType) *serviceerror.ServiceError {
	return nil
}

func (s *InlineStubEntityTypeService) ValidateEntity(ctx context.Context, cat TypeCategory, name string, schema json.RawMessage, flag bool) (bool, *serviceerror.ServiceError) {
	return true, nil
}

func (s *InlineStubEntityTypeService) ValidateEntityUniqueness(ctx context.Context, cat TypeCategory, name string, schema json.RawMessage, eval func(map[string]interface{}) (bool, error)) (bool, *serviceerror.ServiceError) {
	return true, nil
}
