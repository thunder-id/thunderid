...
Add your app's origin to the server-config `cors` section. Create or update `config/resources/server_configs/cors.yaml`, or use `PUT /server-config/cors` after startup.
...
See [Build a Sign-In Flow](../../../../guides/guides/flows/build-a-flow).
...
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| React       | [React Quickstart](../../../../guides/getting-started/connect-your-application/react), `<SignInButton />`, `<SignedIn />`, `<SignedOut />`      |
