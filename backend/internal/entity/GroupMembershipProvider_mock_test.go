...
// GetTransitiveAncestorGroups provides a mock function for the type GroupMembershipProviderMock
func (_mock *GroupMembershipProviderMock) GetTransitiveAncestorGroups(ctx context.Context, groupID string) ([]string, error) {
...
// GroupMembershipProviderMock_GetTransitiveAncestorGroups_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetTransitiveAncestorGroups'
type GroupMembershipProviderMock_GetTransitiveAncestorGroups_Call struct {
	*mock.Call
}
...
func (_c *GroupMembershipProviderMock_GetTransitiveAncestorGroups_Call) Run(run func(ctx context.Context, groupID string)) *GroupMembershipProviderMock_GetTransitiveAncestorGroups_Call {
...
func (_c *GroupMembershipProviderMock_GetTransitiveAncestorGroups_Call) Return(strings []string, err error) *GroupMembershipProviderMock_GetTransitiveAncestorGroups_Call {
	_c.Call.Return(strings, err)
	return _c
}

func (_c *GroupMembershipProviderMock_GetTransitiveAncestorGroups_Call) RunAndReturn(run func(ctx context.Context, groupID string) ([]string, error)) *GroupMembershipProviderMock_GetTransitiveAncestorGroups_Call {
	_c.Call.Return(run)
	return _c
}
