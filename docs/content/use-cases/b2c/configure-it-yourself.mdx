...
SMTP must be configured for recovery emails to reach the user. See [Email Providers](../../guides/guides/notifications/email-providers.mdx) for setup instructions. This is required regardless of which path you chose.
