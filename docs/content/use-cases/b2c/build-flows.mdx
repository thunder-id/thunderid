...
The `emailTemplate` property selects which template the send step uses. To tailor that email's wording, localization, and branding, see [Customize Notifications](../build-notifications).
