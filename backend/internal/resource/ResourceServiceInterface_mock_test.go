...
func (_mock *ResourceServiceInterfaceMock) GetResourceServerList(ctx context.Context, limit int, offset int, ouID string) (*ResourceServerList, *common.ServiceError) {
	...
	var r1 *common.ServiceError
	if returnFunc, ok := ret.Get(0).(func(context.Context, int, int, string) (*ResourceServerList, *common.ServiceError)); ok {
		return returnFunc(ctx, limit, offset, ouID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, int, int, string) *ResourceServerList); ok {
...
func (_c *ResourceServiceInterfaceMock_GetResourceServerList_Call) RunAndReturn(run func(ctx context.Context, limit int, offset int, ouID string) (*ResourceServerList, *common.ServiceError)) *ResourceServiceInterfaceMock_GetResourceServerList_Call {
	_c.Call.Return(run)
	return _c
}
