...
type FlowDefinition struct {
	...
	Nodes    []common.NodeDefinition `json:"nodes" validate:"required" jsonschema:"Array of nodes defining the flow steps. Must include START and END nodes. Use get_flow on existing flows to see node structure examples."`
}
...
type FlowDefinitionRequest struct {
	...
	Nodes    []common.NodeDefinition `json:"nodes" validate:"required"`
}

// CompleteFlowDefinition is an alias for the shared flow definition model.
type CompleteFlowDefinition = common.CompleteFlowDefinition

// NodeDefinition is an alias for the shared node definition model.
type NodeDefinition = common.NodeDefinition

// NodeLayout is an alias for the shared node layout model.
type NodeLayout = common.NodeLayout

// NodeSize is an alias for the shared node size model.
type NodeSize = common.NodeSize

// NodePosition is an alias for the shared node position model.
type NodePosition = common.NodePosition

// InputDefinition is an alias for the shared input definition model.
type InputDefinition = common.InputDefinition

// ValidationRuleDefinition is an alias for the shared validation rule definition model.
type ValidationRuleDefinition = common.ValidationRuleDefinition

// ActionDefinition is an alias for the shared action definition model.
type ActionDefinition = common.ActionDefinition

// PromptDefinition is an alias for the shared prompt definition model.
type PromptDefinition = common.PromptDefinition

// ExecutorDefinition is an alias for the shared executor definition model.
type ExecutorDefinition = common.ExecutorDefinition

// ConditionDefinition is an alias for the shared condition definition model.
type ConditionDefinition = common.ConditionDefinition
...
type FlowVersion struct {
	...
	Nodes     []common.NodeDefinition `json:"nodes"`
...
type updateFlowInput struct {
	...
	Nodes []common.NodeDefinition `json:"nodes" jsonschema:"Array of nodes defining the flow steps. Required for PUT."`
}
