...
3. Under **Technology**, select **Nuxt**.
4. Enter a name (e.g. `My Nuxt App`) and create an application. The rest of the settings can stay at their defaults.
...
6. Under **General**, add `http://localhost:3000/api/auth/callback` to the list of **Authorized Redirect URIs**.
