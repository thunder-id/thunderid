...
:::note Windows Execution Policy
If you see a `SecurityError` stating that `start.ps1` is not digitally signed, your system's PowerShell execution policy blocks unsigned scripts. Run the script with the execution policy bypass flag instead:
