...
func (_mock *ResourceServiceInterfaceMock) GetResourceServerListByOwner(ctx context.Context, ownerID string, ownerType string, limit int, offset int) (*resource.ResourceServerList, *common.ServiceError) {
	...
	var r0 *resource.ResourceServerList
	var r1 *common.ServiceError
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, int, int) (*resource.ResourceServerList, *common.ServiceError)); ok {
		return returnFunc(ctx, ownerID, ownerType, limit, offset)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, int, int) *resource.ResourceServerList); ok {
...
func (_c *ResourceServiceInterfaceMock_GetResourceServerListByOwner_Call) Return(resourceServerList *resource.ResourceServerList, serviceError *common.ServiceError) *ResourceServiceInterfaceMock_GetResourceServerListByOwner_Call {
	_c.Call.Return(resourceServerList, serviceError)
	return _c
}

func (_c *ResourceServiceInterfaceMock_GetResourceServerListByOwner_Call) RunAndReturn(run func(ctx context.Context, ownerID string, ownerType string, limit int, offset int) (*resource.ResourceServerList, *common.ServiceError)) *ResourceServiceInterfaceMock_GetResourceServerListByOwner_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *ResourceServiceInterfaceMock) SetEntityNameResolver(r resource.EntityNameResolver) {
	_mock.Called(r)
	return
}
...
func (_c *ResourceServiceInterfaceMock_SetEntityNameResolver_Call) Run(run func(r resource.EntityNameResolver)) *ResourceServiceInterfaceMock_SetEntityNameResolver_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 resource.EntityNameResolver
		if args[0] != nil {
			arg0 = args[0].(resource.EntityNameResolver)
		}
		run(
			arg0,
		)
...
func (_c *ResourceServiceInterfaceMock_SetEntityNameResolver_Call) RunAndReturn(run func(r resource.EntityNameResolver)) *ResourceServiceInterfaceMock_SetEntityNameResolver_Call {
	_c.Run(run)
	return _c
}
