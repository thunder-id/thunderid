...
| **Continue with eSignet** | Federated login using MOSIP eSignet. |
...
| **eSignet** | Authenticates the user via MOSIP eSignet sign-in. | eSignet identity provider configured |
