...
func (_mock *ConfigurableOUServiceMock) GetOrganizationUnitRoles(ctx context.Context, id string, limit int, offset int) (*ou.RoleListResponse, *serviceerror.ServiceError) {
	ret := _mock.Called(ctx, id, limit, offset)
	...
	var r1 *serviceerror.ServiceError
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, int, int) (*ou.RoleListResponse, *serviceerror.ServiceError)); ok {
		return returnFunc(ctx, id, limit, offset)
	}
...
func (_c *ConfigurableOUServiceMock_GetOrganizationUnitRoles_Call) Return(roleListResponse *ou.RoleListResponse, serviceError *serviceerror.ServiceError) *ConfigurableOUServiceMock_GetOrganizationUnitRoles_Call {
	_c.Call.Return(roleListResponse, serviceError)
	return _c
}

func (_c *ConfigurableOUServiceMock_GetOrganizationUnitRoles_Call) RunAndReturn(run func(ctx context.Context, id string, limit int, offset int) (*ou.RoleListResponse, *serviceerror.ServiceError)) *ConfigurableOUServiceMock_GetOrganizationUnitRoles_Call {
	_c.Call.Return(run)
	return _c
}

// GetOrganizationUnitRolesByPath provides a mock function for the type ConfigurableOUServiceMock
func (_mock *ConfigurableOUServiceMock) GetOrganizationUnitRolesByPath(ctx context.Context, handlePath string, limit int, offset int) (*ou.RoleListResponse, *serviceerror.ServiceError) {
	ret := _mock.Called(ctx, handlePath, limit, offset)
...
func (_c *ConfigurableOUServiceMock_GetOrganizationUnitRolesByPath_Call) Return(roleListResponse *ou.RoleListResponse, serviceError *serviceerror.ServiceError) *ConfigurableOUServiceMock_GetOrganizationUnitRolesByPath_Call {
	_c.Call.Return(roleListResponse, serviceError)
	return _c
}

func (_c *ConfigurableOUServiceMock_GetOrganizationUnitRolesByPath_Call) RunAndReturn(run func(ctx context.Context, handlePath string, limit int, offset int) (*ou.RoleListResponse, *serviceerror.ServiceError)) *ConfigurableOUServiceMock_GetOrganizationUnitRolesByPath_Call {
	_c.Call.Return(run)
	return _c
}
