...
const translations = {
  ...
  userTypes: {
    ...
    'attributes.libraryTitle': 'Attributes',
    'attributes.emptyHint': 'Select attributes from the left to add them to this user type.',
    'attributes.addCustom': 'Add Custom Attribute',
    'attributes.searchPlaceholder': 'Search attributes',
    'attributes.allAdded': 'All available attributes have been added.',
    'attributes.noResults': 'No attributes match your search.',
