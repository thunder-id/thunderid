...
func (_mock *oidcAuthExecutorInterfaceMock) GetUserIDFromContext(ctx *core.NodeContext, execResp *common.ExecutorResponse, authnProvider manager.AuthnProviderManagerInterface) string {
...
func (_c *oidcAuthExecutorInterfaceMock_GetUserIDFromContext_Call) Run(run func(ctx *core.NodeContext, execResp *common.ExecutorResponse, authnProvider manager.AuthnProviderManagerInterface)) *oidcAuthExecutorInterfaceMock_GetUserIDFromContext_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *core.NodeContext
		if args[0] != nil {
			arg0 = args[0].(*core.NodeContext)
...
func (_c *oidcAuthExecutorInterfaceMock_GetUserIDFromContext_Call) RunAndReturn(run func(ctx *core.NodeContext, execResp *common.ExecutorResponse, authnProvider manager.AuthnProviderManagerInterface) string) *oidcAuthExecutorInterfaceMock_GetUserIDFromContext_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *oidcAuthExecutorInterfaceMock) ValidatePrerequisites(ctx *core.NodeContext, execResp *common.ExecutorResponse, authnProvider manager.AuthnProviderManagerInterface) bool {
	ret := _mock.Called(ctx, execResp, authnProvider)
...
func (_c *oidcAuthExecutorInterfaceMock_ValidatePrerequisites_Call) Run(run func(ctx *core.NodeContext, execResp *common.ExecutorResponse, authnProvider manager.AuthnProviderManagerInterface)) *oidcAuthExecutorInterfaceMock_ValidatePrerequisites_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *core.NodeContext
		if args[0] != nil {
			arg0 = args[0].(*core.NodeContext)
...
func (_c *oidcAuthExecutorInterfaceMock_ValidatePrerequisites_Call) RunAndReturn(run func(ctx *core.NodeContext, execResp *common.ExecutorResponse, authnProvider manager.AuthnProviderManagerInterface) bool) *oidcAuthExecutorInterfaceMock_ValidatePrerequisites_Call {
	_c.Call.Return(run)
	return _c
}
