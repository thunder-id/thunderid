...
var (
	...
	queryCreateOrganizationUnit = dbmodel.DBQuery{
		...
		Query: `INSERT INTO "ORGANIZATION_UNIT" (
			...
			AUTH_FLOW_ID, REGISTRATION_FLOW_ID, IS_REGISTRATION_FLOW_ENABLED,
			RECOVERY_FLOW_ID, IS_RECOVERY_FLOW_ENABLED, SIGNOUT_FLOW_ID, IS_SIGNOUT_FLOW_ENABLED,
	...
	queryUpdateOrganizationUnit = dbmodel.DBQuery{
		...
		Query: `UPDATE "ORGANIZATION_UNIT" SET PARENT_ID = $2, HANDLE = $3, NAME = $4, DESCRIPTION = $5, ` +
			`THEME_ID = $6, LAYOUT_ID = $7, AUTH_FLOW_ID = $8, REGISTRATION_FLOW_ID = $9, ` +
			`IS_REGISTRATION_FLOW_ENABLED = $10, RECOVERY_FLOW_ID = $11, IS_RECOVERY_FLOW_ENABLED = $12, ` +
			`SIGNOUT_FLOW_ID = $13, IS_SIGNOUT_FLOW_ENABLED = $14, METADATA = $15, UPDATED_AT = $16 ` +
			`WHERE OU_ID = $1 AND DEPLOYMENT_ID = $17`,
	}
