...
func TestMapToCoreAttrs_AddressObject_UnrecognizedSubAttrsDropped(t *testing.T) {
...
func TestMapToEnterpriseAttrs_EmptyInput(t *testing.T) {
	result := mapToEnterpriseAttrs(nil, "https://example.com")
	require.Nil(t, result)
}

func TestMapToEnterpriseAttrs_InvalidJSON(t *testing.T) {
	result := mapToEnterpriseAttrs(json.RawMessage(`bad json`), "https://example.com")
	require.Nil(t, result)
}

func TestMapToEnterpriseAttrs_NoMatchingAttrs(t *testing.T) {
	result := mapToEnterpriseAttrs(json.RawMessage(`{"username":"jdoe"}`), "https://example.com")
	require.Nil(t, result)
}

func TestMapToEnterpriseAttrs_AllFields(t *testing.T) {
...
func TestReverseMapEnterpriseAttrsForSchema_Success(t *testing.T) {
	schema := json.RawMessage(`{
	...
	require.JSONEq(t, `"mgr-999"`, string(mapped["manager_id"]))
}

func TestReverseMapEnterpriseAttrsForSchema_ManagerScalarString(t *testing.T) {
	schema := json.RawMessage(`{
		"manager_id": {"type": "string"}
	}`)
	input := map[string]json.RawMessage{
...
func TestReverseMapEnterpriseAttrsForSchema_UndeclaredInEnterpriseRule(t *testing.T) {
	schema := json.RawMessage(`{
		"employee_number": {"type": "string"}
	}`)
	input := map[string]json.RawMessage{
...
func TestReverseMapEnterpriseAttrsForSchema_UndeclaredInTargetSchema(t *testing.T) {
...
func TestTranslateSCIMFilterAttr_Enterprise(t *testing.T) {
	...
	require.Equal(t, "manager_id", translateSCIMFilterAttr("manager.value"))
}

func TestIsUnsupportedSCIMFilterAttr_Enterprise(t *testing.T) {
