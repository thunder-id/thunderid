...
- [Act on Behalf of a User](../../../guides/agents/authentication/on-behalf-of-user): Authenticate an agent to an internal API or MCP server and issue on-behalf-of tokens.
