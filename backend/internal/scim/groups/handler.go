...
// newSCIMGroupsHandler creates the groups handler around the given service.
func newSCIMGroupsHandler(svc SCIMGroupsServiceInterface, cfg scimconfig.SCIMConfig) *scimGroupsHandler {
	return &scimGroupsHandler{
		svc:           svc,
